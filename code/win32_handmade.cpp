                           ...
                           HDC DeviceContext, int WindowWidth, int WindowHeight)
{
	if (WindowWidth == Buffer->Width * 2 && WindowHeight == Buffer->Height * 2)
	{
		...
		PatBlt(DeviceContext, 0, Buffer->Height, WindowWidth, WindowHeight - Buffer->Height, BLACKNESS);
...
#else
	DEBUGGlobalShowCursor = 0;
#endif

    WNDCLASSA WindowClass = {};
    Win32ResizeDIBSection(&GlobalBackbuffer, RENDER_WIDTH, RENDER_HEIGHT);
    ...
    if(RegisterClassA(&WindowClass))
    {
        HWND Window =
            CreateWindowExA(
                ...
                RENDER_WIDTH + 16, RENDER_HEIGHT + 39,
                0, 0, Instance, 0);
        if(Window)
        {
